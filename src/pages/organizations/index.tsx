  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('attachment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.attachment,
        }
      : null,
    hasAccess('grenade', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'grenade',
          header: 'Grenade',
          accessorKey: 'grenade',
          cell: ({ row: { original: record } }: any) => record?._count?.grenade,
        }
      : null,
    hasAccess('map', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'map',
          header: 'Map',
          accessorKey: 'map',
          cell: ({ row: { original: record } }: any) => record?._count?.map,
        }
      : null,
    hasAccess('mission', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'mission',
          header: 'Mission',
          accessorKey: 'mission',
          cell: ({ row: { original: record } }: any) => record?._count?.mission,
        }
      : null,
    hasAccess('pass', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'pass',
          header: 'Pass',
          accessorKey: 'pass',
          cell: ({ row: { original: record } }: any) => record?._count?.pass,
        }
      : null,
    hasAccess('weapon', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'weapon',
          header: 'Weapon',
          accessorKey: 'weapon',
          cell: ({ row: { original: record } }: any) => record?._count?.weapon,
        }
      : null,
