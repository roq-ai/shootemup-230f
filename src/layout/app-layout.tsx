...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Grenades', path: '/grenades', entity: 'grenade', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    { name: 'Loadouts', path: '/loadouts', entity: 'loadout', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    { name: 'Maps', path: '/maps', entity: 'map', service: AccessServiceEnum.PROJECT, icon: FiMap },
    { name: 'Missions', path: '/missions', entity: 'mission', service: AccessServiceEnum.PROJECT, icon: FiAward },
    { name: 'Passes', path: '/passes', entity: 'pass', service: AccessServiceEnum.PROJECT, icon: FiCheckCircle },
    { name: 'Weapons', path: '/weapons', entity: 'weapon', service: AccessServiceEnum.PROJECT, icon: FiTarget },
